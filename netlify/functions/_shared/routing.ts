...
export const VOICE_CHOICES: VoiceChoice[] = [
  ...
  },
  {
    ...
    it: 'Locale e gratuito. È la scelta consigliata per i compiti semplici che non richiedono la qualità dei modelli cloud.',
    webSearch: false,
    data: 'Resta sul Mac: prompt e risposta non vengono inviati a un fornitore cloud.',
  },
  {
    provider: 'ollama',
    model: 'qwen2.5:14b',
    label: 'Qwen 2.5 14B',
    price: { input: 0, output: 0 },
    it: 'Locale e gratuito. Alternativa a GPT-OSS per attività semplici.',
    webSearch: false,
    data: 'Resta sul Mac: prompt e risposta non vengono inviati a un fornitore cloud.',
  },
  {
    ...
    label: 'Llama 3.2 3B',
    price: { input: 0, output: 0 },
    it: 'Locale e gratuito, ma molto piccolo: adatto soltanto a richieste basilari.',
    webSearch: false,
    data: 'Resta sul Mac: prompt e risposta non vengono inviati a un fornitore cloud.',
  },
  {
