      ...
      <div className="eggchoice__grid">
        {eggs.map((egg, i) => {
          ...
          return (
            ...
            >
              <span className="t-meta eggchoice__slot">[ BABY {String(i + 1).padStart(2, '0')} ]</span>
              ...
              >
                <Sigil seed={egg.sigil} size={56} />
              </span>
              <span className="eggchoice__facts">
                <span className="t-meta eggchoice__fact">{egg.data.family}</span>
                <span className="t-micro eggchoice__fact eggchoice__fact--sub">{'NUL · primo stadio'}</span>
              </span>
