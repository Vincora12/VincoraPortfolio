...
export const PASSI: Passo[] = [
  ...
  { id: "5.5", fase: "C", nome: "Humanoidity", sub: "quanto resta leggibile come umano", critico: false, istruzione: "Choose humanoidity 1–5 inside the Family range, shifted only by an explicit Archetype modifier. This executes here, after Appearance.", kind: "", agent: "code", run: "auto" },
