...
export const PASSI: Passo[] = [
  ...
  { id: "26", fase: "I", nome: "Narrator Line", sub: "VINZ.MON indicizza l'arrivo · ai/narratorPrompt.ts", critico: true, istruzione: "An AI call writes the system's cold-terminal voice indexing this arrival, reading Character Data, World and the story ledger. Falls back to a deterministic terminal line (narratorFallbackLine) with no key or on a failed/rejected call — the narrator always speaks, never blank.", kind: "runtime-step derived", agent: "ai", run: "runtime" },
];
