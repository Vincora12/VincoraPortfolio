...
export const FAMILIES: FamilyDef[] = [
  {
    ...
    absoluteRule: 'Wings/rings/feathers are anatomy. The figure remains recognizably humanoid and always has two primary facial eyes as its focal point. Extra heads, eyes, arms, wings or floating anatomy appear ONLY when the selected Archetype explicitly authorizes them. Never borrow one Archetype signature feature for another. Never generic angel costume.',
    fit: { REC: 0.22, CARE: 0.18, warmth: 0.16, introspection: 0.14, discipline: 0.12, mystery: 0.1, social: 0.08 },
    supportsHair: true,
    supportsEyewear: true,
    humanoidity: [3, 5],
    archetypes: [
      { id: 'PUTTO', structure: 'Simple small humanoid proportions, exactly two arms, two primary eyes and one pair of short wings. No extra anatomy.', mass: 'COMPACT', humanShift: 1 },
      { id: 'MESSENGER', structure: 'Simple lean humanoid with exactly two arms, two primary eyes and one directional pair of wings. Body parts or accessories may float, but their count does not increase.', mass: 'COMPACT' },
      { id: 'GUARDIAN', structure: 'Simple young male humanoid learning to fight: exactly two arms, two primary eyes, one modest pair of wings, light incomplete practice armour and slightly oversized training equipment. The apprentice read comes from construction, never mood.', mass: 'COMPACT', humanShift: 1 },
      { id: 'WARRIOR', structure: 'Humanoid celestial warrior with exactly four physical arms, designed to use different weapons and defenses simultaneously. Keep two primary facial eyes.', mass: 'BALANCED' },
      { id: 'VIRTUE', structure: 'Humanoid with exactly two arms and two primary eyes. Miraculous nature appears through light, energy, aura, symbols or supernatural phenomena rather than additional anatomy.', mass: 'BALANCED' },
      { id: 'POWER', structure: 'Robust humanoid with four to six physical armoured arms. Secondary eyes may appear only on the armour; two primary facial eyes remain dominant.', mass: 'MASSIVE' },
      { id: 'DOMINION', structure: 'Humanoid with exactly two arms and two primary eyes. Complexity comes from symmetry, ritual geometry, ornament and authoritative vertical presence, not extra anatomy.', mass: 'BALANCED' },
      { id: 'CHERUB', structure: 'Recognizable humanoid with exactly two arms. Multiple heads, additional wings and numerous eyes on the wings are permitted. Keep the solution lively, charming and playful rather than grotesque; the primary facial eyes remain the focal point.', mass: 'MASSIVE' },
      { id: 'THRONE', structure: 'Recognizable humanoid with exactly two arms. Many eyes inhabit integrated rings; orbiting structures and floating parts are permitted. The main face and its two primary eyes remain recognizable.', mass: 'MASSIVE' },
      { id: 'SERAPH', structure: 'Recognizable terminal humanoid framed by exactly six wings. Additional arms and secondary eyes are permitted with maximum controlled freedom, while the two primary facial eyes remain the focal point.', mass: 'MASSIVE' },
    ],
  },
  {
    id: 'BEAST',
...
export const AFFINITIES: AffinityDef[] = [
  { id: 'ANGEL', effect: 'Secondary wings, rings, feathers and luminous/ritual symmetry. Additional anatomy appears only when the selected Family Archetype explicitly permits it; two primary facial eyes remain the focal point.', it: 'qualcosa di celeste gli è cresciuto addosso' },
