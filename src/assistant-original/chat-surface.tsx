...
export const ChatSurface: FC<ChatSurfaceProps> = ({ model, onModelChange, embedded = false }) => {
  const picker = (
    <ModelSelector
      models={MODELS}
  ...
  if (embedded) {
    return (
      <main className="assistant-clone relative flex h-full min-h-0 flex-col overflow-hidden bg-white text-[#0d0d0d]">
