...
/* 🔶 QUI C'ERANO ~170 RIGHE DI CONTROLLI SULLA STANZA — parentela, post di
   arrivo, giro settimanale, avviso, blocco per il briefing. Sono uscite con
   la funzione: un controllo che verifica codice che non esiste piu' non
   protegge niente, e la prima volta che rompe manda a cercare una cosa che
   nessuno usa. 🔷 «Mindsocial togliamolo proprio.» */
...
/* 🔶 E qui c'erano i controlli sul blocco della stanza nel briefing. Fuori
   con la stanza. */
